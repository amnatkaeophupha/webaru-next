...
<nav class="ml-auto hidden self-stretch lg:flex" aria-label="เมนูหลัก">
    ...
    <div class="flex h-full items-stretch">
        ...
        <div x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false" @focusin="open = true"
            ...
            class="static flex shrink-0 items-stretch">


            <button type="button" @click="open = !open" :aria-expanded="open.toString()" aria-haspopup="true"
                @class([ 'flex h-full items-center justify-center whitespace-nowrap border-b-2 px-3 text-[13px] font-medium transition-colors duration-150 xl:px-4 xl:text-sm' , 'border-aru-primary text-aru-primary'=> $active,
            ...
            <div x-cloak x-show="open" x-transition:enter="transition ease-out duration-200"
                ...
                x-transition:leave-end="opacity-0 -translate-y-2" class="absolute left-0 right-0 top-full z-50">
        ...
        <a href="{{ $menu['url'] }}"
            ...
            rel="noopener noreferrer" @endif
            @class([ 'flex h-full shrink-0 items-center justify-center whitespace-nowrap border-b-2 px-3 text-[13px] font-medium transition-colors duration-150 xl:px-4 xl:text-sm' , 'border-aru-primary text-aru-primary'=> $active,
        ...
        <div class="space-y-1">
            ...
            <div class="rounded-xl">
                ...
                <button type="button"
                    ...
                    @class([ 'flex w-full items-center justify-between gap-3 rounded-xl px-4 py-3 text-left text-sm transition-colors duration-150 hover:bg-aru-surface-soft hover:text-aru-primary' , 'bg-aru-primary/10
                                                                                                                     font-semibold
            ...
            <a href="{{ $menu['url'] }}"
                @if ($menu['new_tab'] ?? false) target="_blank"
                rel="noopener noreferrer" @endif
                @click="mobileMenuOpen = false" @class([ 'flex w-full items-center rounded-xl px-4 py-3 text-sm transition-colors duration-150 hover:bg-aru-surface-soft hover:text-aru-primary' , 'bg-aru-primary/10
                                                                                                     font-semibold
                                                                                                     text-aru-primary'=> $active,
