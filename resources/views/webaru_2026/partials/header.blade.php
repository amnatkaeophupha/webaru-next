<header x-data="{ mobileMenuOpen: false }"
    ...
    <div class="bg-aru-primary text-white">
        <div class="webaru-container flex h-9 items-center justify-end gap-4 text-xs sm:gap-5 lg:text-[13px]">
            ...
            <button type="button"
                class="inline-flex items-center gap-1.5 font-medium transition hover:text-aru-gold"
    ...
    <div class="bg-white">
        <div class="webaru-container flex min-h-[82px] items-center gap-5 lg:min-h-[88px] xl:gap-8">
            ...
            <a href="{{ route('2026.home') }}" class="flex shrink-0 items-center gap-3.5" aria-label="หน้าแรก มหาวิทยาลัยราชภัฏพระนครศรีอยุธยา">
                <img src="{{ asset('images/webaru_2026/logo/aru-logo.png') }}"
                    alt="ตราสัญลักษณ์มหาวิทยาลัยราชภัฏพระนครศรีอยุธยา"
                    class="h-14 w-auto sm:h-[62px]">

                <div class="hidden sm:block">
                    <div class="text-[15px] font-extrabold leading-[1.25] text-aru-text lg:text-base">
                        มหาวิทยาลัยราชภัฏ
                        <br>
                        พระนครศรีอยุธยา
                    </div>
                    <div class="mt-1 text-[8px] font-medium uppercase tracking-[0.035em] text-aru-muted lg:text-[9px]">
                        Phranakhon Si Ayutthaya Rajabhat University
                    </div>
                </div>
            </a>

            <div class="ml-auto min-w-0 flex-1 lg:ml-4 xl:ml-8">
